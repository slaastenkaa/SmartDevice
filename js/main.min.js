...
/* harmony import */ var _modules_mask_phone_phone_mask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/mask-phone/phone-mask */ "./js/modules/mask-phone/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordion"])();
  Object(_modules_scroll_scroll__WEBPACK_IMPORTED_MODULE_4__["initScroll"])();
  Object(_modules_tab_tab__WEBPACK_IMPORTED_MODULE_5__["initTab"])();
  Object(_modules_mask_phone_phone_mask__WEBPACK_IMPORTED_MODULE_6__["initPhoneMask"])();
...
function initAccordion() {
  ...
  var accordionContent = document.querySelectorAll('[data-accordion]');
  ...
  function removeOpen(indexClose) {
    accordionContent.forEach(function (itemSecond, indexSecond) {
...
/***/ "./js/modules/mask-phone/phone-mask.js":
/*!*********************************************!*\
  !*** ./js/modules/mask-phone/phone-mask.js ***!
  \*********************************************/
...
function initScroll() {
  var scrollButtons = document.querySelectorAll('[data-scroll-button]');
  var _iterator = _createForOfIteratorHelper(scrollButtons),
    _step;
  try {
    var _loop = function _loop() {
      var scrollButton = _step.value;
...
function initTab() {
  ...
  var tabMoreButtons = document.querySelectorAll('[data-tabmore-button]');
  var tabMoreText = document.querySelector('[data-tabmore-text]');
  tabMoreButtons.forEach(function (item) {
